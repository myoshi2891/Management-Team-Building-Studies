  ...
  it("カテゴリー順・カテゴリー内定義順でグルーピングする", () => {
    expect(groupGuidesByCategory().map((group) => ({
    ...
    }))).toEqual([
      {
        ...
        guides: ["CAPM 完全ガイド", "CAPM ドメイン1", "CAPM ドメイン2", "CAPM ドメイン3", "CAPM ドメイン4", "PMP 完全攻略", "PMP ドメイン1", "PMP ドメイン2", "PMP ドメイン3", "CSM 完全ガイド", "CSM 3つのアカウンタビリティ", "CSM Scrum理論", "CSM スクラムイベント", "スクラム 97の知恵", "CAL1 完全ガイド", "CAL1 第1章", "CAL1 第3章", "CAL2 Part 1", "CAL2 完全ガイド"],
      },
      {
    ...
    expect(groupGuidesByCategory().map((group) => ({
    ...
    }))).toEqual([
      {
        ...
        seriesGroups: [
          ...
          { seriesId: "scrum", guides: ["CSM 完全ガイド", "CSM 3つのアカウンタビリティ", "CSM Scrum理論", "CSM スクラムイベント", "スクラム 97の知恵", "CAL1 完全ガイド", "CAL1 第1章", "CAL1 第3章", "CAL2 Part 1", "CAL2 完全ガイド"] },
        ],
      },
      {
