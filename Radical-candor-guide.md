...
> 本ガイドは、Kim Scott 著『Radical Candor: Be a Kick-Ass Boss Without Losing Your Humanity』の中核概念を、ソフトウェアエンジニアやプロジェクトマネージャーが実務で使えるようステップバイステップで整理したものです。2026年8月23日時点の情報をもとに、公式情報源および著名なテック企業のエンジニア・エンジニアリングマネージャーによる実践知を調査し、根拠となるURLを本文末尾の参考文献に記載しています。
...
| next **S**t**E**ps | 次に何をすべきか、あるいは何を一緒に考えたいかを明確にする |
