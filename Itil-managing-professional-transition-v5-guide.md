...
- 更新サイクル: **3年ごと**
- 更新方法: PeopleCert Plus 会員として **60 CPD ポイント** を蓄積するか、同一 Product Suite 内の別モジュールを再受験する
...
組織が置かれる状況は「予測可能で秩序立っている（Ordered/Clear）」ものから「予測不能で混沌としている（Chaotic）」ものまで幅があります。ITIL Transformation Modelはこの違いに応じてアプローチを変える柔軟性を持つことが特徴です。

| コンテキストの性質 | 適したアプローチの傾向 |
|---|---|
| 秩序立っている・予測可能 | 詳細な事前計画、明確なガバナンス、既知のベストプラクティスの適用 |
