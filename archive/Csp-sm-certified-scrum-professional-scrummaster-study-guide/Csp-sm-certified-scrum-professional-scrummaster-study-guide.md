...
*本ガイドは2026年8月時点で公開されている一次情報源に基づいて作成されています（更新料の金額のみ2026年9月1日時点で確認しています）。Scrum Alliance の認定制度・料金・プログラム構成（特に CEC/CTC から Certified Agility Consultant への移行など）は変更される可能性があるため、正式な受講・申請前には必ず Scrum Alliance 公式サイトで最新情報をご確認ください。*
