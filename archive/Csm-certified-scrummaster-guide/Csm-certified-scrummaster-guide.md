...
| コース費用 | CSTや地域・開催形式・提供内容によって大きく異なり、Scrum Allianceは統一価格を定めていない。受講を検討しているコースの詳細ページで必ず最新の金額を確認すること(過去には2023年10月時点の公開価格で250〜2,495米ドルの幅が観測されているが、これは現在の案内ではなく歴史的な参考値) |
