...
| 資格の有効期限 | 生涯有効(更新料なし) |
| パスワードの有効期限 | 期限なし。ただし1つのパスワードで受験できるのは1回のみ(1回の受験で消費される)。例外として、Scrum.org公式クラスの受講者は、初回スコアが85%未満だった場合に限り、パスワード受領から14日以内であれば追加費用なしで再受験できる |

(出典: 1)

> **[注意]** 一部のトレーニングパートナー(再受験企業など)のページでは「40問・60分」「45分」など異なる数値が掲載されている場合があります。**受験直前は必ず公式の認定ページ(出典1)と、受験時に自身へ案内された試験要項の両方を確認してください。**
