...
A-CSM の LO は以下の6カテゴリーに分類されます。教育実施団体（Path to CSP® Educators）はこれに加えて補助トピックを含めることができますが、その場合は明示的に「補助トピックである」と示す必要があります。
...
全26のラーニングオブジェクティブを横断して実践する際の総合チェックリストです。日々の業務や1on1、レトロスペクティブの準備時に参照してください。
