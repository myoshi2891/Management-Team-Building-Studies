...
| 要素 | 英語表記 | 内容 |
|---|---|---|
| 心理的安全性 | Psychological Safety | 対人リスクを取っても安全だと信じられる状態（他のすべての土台となる最重要要素） |
| 相互信頼 | Dependability | メンバーが質の高い仕事を時間通りにやり遂げること |
| 構造と明確さ | Structure and Clarity | チームの役割、計画、目標が明確であること |
| 仕事の意味 | Meaning | メンバー各自が仕事そのものや成果に意味を見出していること |
| インパクト | Impact | 自分の仕事が組織や社会に変化をもたらしていると実感できること |
...
*図6：一般的なエンジニア向けパフォーマンスレビューのプロセス*
...
*図7：DORAとSPACEの関係性（Nicole Forsgrenの説明に基づく）*
...
*図8：AIエージェントの普及に伴うエンジニアリングマネージャーの役割変化（2026年時点の動向）*
