...
Googleが2012年から実施した大規模調査「Project Aristotle」は、180のチームを対象に、250以上の調査項目(チームの属性)を分析し、**チームの効果性を最も強く左右する要因は、個々のメンバーの能力ではなく「心理的安全性」である**という結論を導き出しました。心理的安全性とは、Harvard Business SchoolのAmy Edmondson教授が定義した「対人関係においてリスクを取っても安全だとチームメンバーが共有して信じている状態」を指します。
