...
export const GUIDE_SERIES = [
  ...
  { id: "so-user-experience", programId: "scrum-org", navLabel: "ユーザーエクスペリエンス", cardLabel: "USER EXPERIENCE" },
...
export const GUIDES = [
  ...
  {
    to: "/professional-scrum-product-owner",
    programId: "scrum-org",
    seriesId: "so-product-owner",
    navLabel: "PSPO 完全ガイド",
    title: "Professional Scrum Product Owner™(PSPO I / PSPO II)学習ガイド",
    description: "Scrum.org公認 Professional Scrum Product Owner(PSPO I/II)認定試験の出題範囲を、価値最大化の本質からEBM、優先順位付け、スクラムイベントでの振る舞いまで体系的に解説する学習ガイド。",
    meta: "7セクション",
    icon: "tabler:award",
    accent: "indigo",
  },
  ...
  },
  {
    ...
    description: "Scrum.org公式のProfessional Scrum Facilitation Skills(PSFS)認定資格について、出題範囲・ファシリテーション原則・スキルと資質・イベント別技法・練習問題までを初学者向けに解説するガイドです。",
    meta: "14セクション",
    icon: "tabler:users",
    accent: "indigo",
  },
  {
    to: "/professional-scrum-with-kanban",
    programId: "scrum-org",
    seriesId: "so-kanban",
    navLabel: "PSK 完全ガイド",
    title: "Professional Scrum with Kanban(PSK I)認定資格 完全ガイド",
    description: "Scrum.org公式のThe Kanban Guide for Scrum Teamsに基づき、PSK I認定試験に必要なフローメトリクスとカンバンプラクティスを体系的に解説する非公式学習ガイドです。",
    meta: "7セクション",
    icon: "tabler:layout-kanban",
    accent: "indigo",
  },
  {
    to: "/scaled-professional-scrum-guide",
    programId: "scrum-org",
    seriesId: "so-scaling",
    navLabel: "SPS 完全ガイド",
    title: "Scaled Professional Scrum(SPS)認定 完全学習ガイド",
    description: "Scrum.org Scaled Professional Scrum(SPS)認定試験対策として、Nexusフレームワークの責任・イベント・作成物を初学者にも分かりやすく解説し、実務のベストプラクティスと一次情報源を整理した完全ガイド。",
    meta: "13セクション",
    icon: "tabler:building-bank",
    accent: "indigo",
  },
  {
    to: "/professional-scrum-with-user-experience",
    programId: "scrum-org",
    seriesId: "so-user-experience",
    navLabel: "PSU 完全ガイド",
    title: "Professional Scrum™ with User Experience(PSU I) 完全ガイド",
    description: "Scrum.org Professional Scrum with User Experience(PSU I)認定資格を初学者向けに体系解説。Scrumフレームワーク、Dual-Track Agile、Lean UXの実践知識とベストプラクティスをMermaid図解と模擬問題付きで網羅。",
    meta: "9セクション",
    icon: "tabler:palette",
    accent: "indigo",
  },
