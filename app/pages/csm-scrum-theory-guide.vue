    ...
    <div class="layout">
      ...
      <main class="main-content">
        ...
        <section id="about-guide">
          ...
          <h3>CSM®試験の全体像</h3>
          <p>CSM®は、Scrum Alliance®が提供する入門レベルのScrumマスター認定資格です。認定講師(CST®)による16時間のトレーニングコースを受講した後、オンラインの選択式試験(50問中37問正解=74%以上で合格)を受験します。試験は1時間以内に完了する必要があり、コース修了後90日以内に2回まで受験できます(コース費用に2回分の受験権が含まれます)。</p>
