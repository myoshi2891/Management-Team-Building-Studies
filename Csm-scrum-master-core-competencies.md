...
CSM は Scrum Alliance が提供する Scrum Master トラックの入門認定です。Scrum の全体像(アカウンタビリティ・イベント・アーティファクト)を学びながら、Scrum Master として何を身につけるべきかを、認定トレーナーである Certified Scrum Trainer®(CST®)から対面で学ぶコース形式の認定です。
...
| --- | --- | --- |
| 答えを与える | **Teaching**: 決まった知識・スキルを教える | **Mentoring**: 自分の経験に基づき助言する |
