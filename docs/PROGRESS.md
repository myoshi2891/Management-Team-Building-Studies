...
| フィールド | 値 |
|---|---|
| コードコミット HEAD | `ac14892` — chore(archive): move The Case for Agile Leadership guide sources to archive directory（本ファイルのコミットより前のコード側コミット） |
