...
| フィールド | 値 |
|---|---|
| コードコミット HEAD | `8d7c82a` — chore(archive): move PAL-EBM html and md sources to archive（本ファイルのコミットより前のコード側コミット） |
