...
| フィールド | 値 |
|---|---|
| コードコミット HEAD | `9792578` — refactor(csp-sm): archive source files and verify typecheck and lint（本ファイルのコミットより前のコード側コミット） |
