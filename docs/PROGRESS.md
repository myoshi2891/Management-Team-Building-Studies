...
| フィールド | 値 |
|---|---|
| コードコミット HEAD | `157c218` — refactor(dev-arch): archive source files and verify type/lint quality（本ファイルのコミットより前のコード側コミット） |
