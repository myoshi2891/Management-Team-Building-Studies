...
| 監査スクリプト | — | `npm run audit:no-rules-rules` | **exit 0**（全要素一致） |
...
完了済み:
  ...
  - 全ページ型検査 (nuxi typecheck) / リンター (eslint) / 原本照合監査は全 33 本 exit 0 パス

ベースラインテスト数: ユニット 890 + E2E 15
```
