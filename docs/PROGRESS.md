...
| フィールド | 値 |
|---|---|
| コードコミット HEAD | `db4531b` — refactor(cal1-ch3): move source files to archive and verify quality gates（本ファイルのコミットより前のコード側コミット） |
