...
完了済み:
  ...
  - ユニットテスト 1649 件 / E2E 29 件（全ページ x 3 幅の横スクロール禁止ゲートを含む）
  ...
  - 全ページ型検査 (nuxi typecheck) / リンター (eslint) / 原本照合監査は全 62 本 exit 0 パス

ベースラインテスト数: ユニット 1649 + E2E 29
```
