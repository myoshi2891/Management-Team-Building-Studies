...
| フィールド | 値 |
|---|---|
| コードコミット HEAD | `84f397d` — fix(nav): keep the height cap off the mobile accordion（本ファイルのコミットより前のコード側コミット） |
...
完了済み:
  ...
  - ユニットテスト 1467 件 / E2E 23 件（全ページ x 3 幅の横スクロール禁止ゲートを含む）
