...
完了済み:
  ...
  - 全ページ型検査 (nuxi typecheck) / リンター (eslint) / 原本照合監査は全 20 本 exit 0 パス

ベースラインテスト数: ユニット 585 + E2E 13
```
