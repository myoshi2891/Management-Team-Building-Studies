...
完了済み:
  ...
  - ユニットテスト 634 件
  - test / typecheck / lint はいずれも 2026-08-22 時点で ✔（実測）
  - 全ページ型検査 (nuxi typecheck) / リンター (eslint) / 原本照合監査は全 23 本 exit 0 パス

ベースラインテスト数: ユニット 634 + E2E 13
```
