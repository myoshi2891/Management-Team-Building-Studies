...
| フィールド | 値 |
|---|---|
| コードコミット HEAD | `f385629` — test(disclaimer): measure the inset after a client-side transition（本ファイルのコミットより前のコード側コミット） |
