...
| フィールド | 値 |
|---|---|
| コードコミット HEAD | `95da62f` — feat(pspbm): implement sec 14-15 glossary, references and complete markup（本ファイルのコミットより前のコード側コミット） |
