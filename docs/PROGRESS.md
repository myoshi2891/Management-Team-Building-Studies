...
| フィールド | 値 |
|---|---|
| コードコミット HEAD | `90a1cf0` — test(csd): add source parity and component contract tests for CSD guide（本ファイルのコミットより前のコード側コミット） |
