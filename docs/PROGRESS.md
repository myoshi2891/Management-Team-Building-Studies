...
| フィールド | 値 |
|---|---|
| コードコミット HEAD | `403bbc7` — refactor(cal1-ch4): move original source files to archive and add audit script（本ファイルのコミットより前のコード側コミット） |
