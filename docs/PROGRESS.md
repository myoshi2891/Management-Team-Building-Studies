...
| フィールド | 値 |
|---|---|
| コードコミット HEAD | `02d33ae` — refactor(casp): archive original html and md files and update audit script path（本ファイルのコミットより前のコード側コミット） |
