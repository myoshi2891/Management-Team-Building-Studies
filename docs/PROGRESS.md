...
| Table 構成 | 6 件（計 83 行） | 同数・完全一致 | 原本の表構造を 100% 保持 |
...
完了済み:
  ...
  - 全ページ型検査 (nuxi typecheck) / リンター (eslint) / 原本照合監査は全 27 本 exit 0 パス

ベースラインテスト数: ユニット 726 + E2E 13
```
