...
**ステップ2：スクラムチームを編成する**
プロダクトオーナー・スクラムマスター・開発者を任命します。スクラムチームは「機能横断型（cross-functional）」である必要があります。これは任意の推奨ではなく、各スプリントで価値あるインクリメントを生み出すために必要なスキルを、チーム全体として備えていなければならないという要件です。
