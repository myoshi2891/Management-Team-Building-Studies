...
| 結合度・凝集度 | モジュール間の依存が疎か、責務がまとまっているか |
...
CSP-D は「取得して終わり」ではなく、**2年ごとに Scrum Education Units（SEU）40単位を取得**して更新する必要があります。SEU は書籍を読む、ウェビナーを視聴する、イベントに参加するなど、継続的な学習活動によって蓄積されます。
...
CSP-D 取得者には **Comparative Agility®** のプレミアム購読が特典として提供されます。これは、チーム・組織のアジリティを7つの次元（チームワーク、要求、計画、技術的実践、品質、文化、知識創造）で診断し、業界内での相対比較を可能にするアセスメントプラットフォームです。
...
*本ガイドは、上記出典に基づき教育目的で作成された非公式の学習補助資料です。認定試験・コースの正式な内容については、必ず Scrum Alliance 公式サイトおよび認定教育提供者（REP/CTC）の最新情報をご確認ください。*
